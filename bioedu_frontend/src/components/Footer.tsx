      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-500">
              ...
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Simulations</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors">AI Tutor</a></li>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-zinc-500">
            <a href="#" className="hover:text-zinc-50 transition-colors"><Twitter className="w-5 h-5" /></a>
            <a href="#" className="hover:text-zinc-50 transition-colors"><Github className="w-5 h-5" /></a>
            <a href="#" className="hover:text-zinc-50 transition-colors"><Linkedin className="w-5 h-5" /></a>
          </div>
        </div>
      </div>
    </footer>
